    ...
    <div class="content">
      <form action="Register" method="post">
        <div class="user-details">
          ...
          <div class="input-box">
            <span class="details">Street number</span>
            <input type="text" placeholder="Enter your Street Number" required name="streetno">
          </div>
          <div class="input-box">
          ...
          <div class="input-box">
            ...
            <input type="text" placeholder="Enter your number" required name="phone_num">
          </div>
          <div class="input-box">
